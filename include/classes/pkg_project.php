...
// jburk: removed user timezone to fix static/nonstatic warning:
//   Strict Standards: Non-static method Tzn::_getUserTZ() should not be called statically in /home/itfmars/tasks.itf.marssociety.org/include/classes/pkg_project.php on line 28
define('PRJ_DTE_NOW',strtotime(date('Y-m-d',time())));
