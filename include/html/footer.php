...
?>
    ...
    ?>
        <a href="http://www.taskfreak.com">TaskFreak! multi user</a> v<?php echo FRK_VERSION; ?> - Released on <?php echo FRK_VERSION_RELEASE; ?> under GNU General Public License [<a href="https://github.com/jamesburk/taskfreak-tms">github link</a>]
    </div>
</div>
<?php
}   
