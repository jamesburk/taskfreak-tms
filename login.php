...
if (isset($_POST["username"])) {
	if ($objUser->login($_POST["username"],$_POST["password"])) {
		...
		if ($pRef) {
			(new Tzn)->redirect($pRef);
//			Tzn::redirect($pRef);
		} else {
			(new Tzn)->redirect('index.php');
	...
	<form action="login.php" method="post">
        ...
        <table cellpadding="3" cellspacing="0" border="0" align="center">
            <tr>
                ...
                <td><?php (new Tzn)->qText('username',$_REQUEST['username'],'width:130px'); ?></td>
            ...
            <tr>
                <td colspan="2" align="center">
                    <?php 
                        (new Tzn)->qCheckBox('remember','','vertical-align:middle');
